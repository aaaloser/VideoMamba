...
def get_args():
    ...
    parser.add_argument('--ptq_tau_percentile', type=float, default=90.0,
                        help='Percentile used to derive tau from calibration scores')
    parser.add_argument('--ptq_high_ratio_threshold', type=float, default=0.30,
                        help='High-sensitivity ratio threshold for block bit routing')
    parser.add_argument('--ptq_high_bit', type=int, default=8,
    ...
    parser.add_argument('--ptq_beta', type=float, default=0.25,
                        help='Weight of spatial entropy in sensitivity fusion')
    parser.add_argument('--ptq_gamma', type=float, default=0.25,
                        help='Weight of temporal entropy in sensitivity fusion')
